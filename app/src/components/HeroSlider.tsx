...
const slides = [
  ...
  },
  {
    ...
    title: 'Produits chimiques de laboratoire pour l\'analyse et la recherche.',
    desc: 'Solvants, réactifs et acides de qualité analytique, avec fiche technique et spécifications détaillées pour chaque référence.',
  ...
  },
  {
    ...
    desc: 'Équipements de laboratoire pédagogique, de recherche, industriel et pharmaceutique — instruments de mesure et d\'analyse.',
